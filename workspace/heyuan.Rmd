...
To create a POMP for CPUE, I need to define the state process that reflects the underlying dynamics of the species population and the observation process that relates the state to the CPUE measurements.
