...
We choose the ARMA(3,2), as out simple benchmark model. The corresponding log-likelihood value comes out to be **-105.93**.
...
arma_model <- Arima(bird_ts, order = c(3, 0, 2))
